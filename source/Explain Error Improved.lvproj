...
<Project Type="Project" LVVersion="20008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Explain Error (Improved).llb" Type="Folder">
			<Item Name="Execute Explain Error (Improved).vi" Type="VI" URL="../Explain Error (Improved).llb/Execute Explain Error (Improved).vi"/>
			<Item Name="Explain Error (Improved).ctl" Type="VI" URL="../Explain Error (Improved).llb/Explain Error (Improved).ctl"/>
			<Item Name="Explain Error (Improved).vi" Type="VI" URL="../Explain Error (Improved).llb/Explain Error (Improved).vi"/>
		</Item>
		<Item Name="Explain Error Improved Dialog.lvlib" Type="Library" URL="../Explain Error (Improved)/Explain Error Improved Dialog/Explain Error Improved Dialog.lvlib"/>
		<Item Name="Package Dependencies" Type="IIO Ladder Diagram">
			<Property Name="NI.SortType" Type="Int">0</Property>
			<Property Name="ShowPackages" Type="Bool">true</Property>
		</Item>
		<Item Name="Test - Explain Better Error.vi" Type="VI" URL="../Explain Error (Improved)/Test - Explain Better Error.vi"/>
